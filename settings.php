...
$settings->add(new admin_setting_configtextarea(            
	...
	get_string('default_infotext', 'mod_ildreqdocs')
));
...
$settings->add(new admin_setting_configtext(            
	...
	get_string('default_first_mail_subject', 'mod_ildreqdocs')
));
...
$settings->add(new admin_setting_configtextarea(            
	...
	get_string('default_first_mail_content', 'mod_ildreqdocs')
));
...
$settings->add(new admin_setting_configtext(            
	...
	get_string('default_second_mail_subject', 'mod_ildreqdocs')
));
...
$settings->add(new admin_setting_configtextarea(            
	...
	get_string('default_second_mail_content', 'mod_ildreqdocs')
));
...
$settings->add(new admin_setting_configtext(            
	...
	get_string('default_responsible_mail_subject', 'mod_ildreqdocs')
));
...
$settings->add(new admin_setting_configtextarea(            
	...
	get_string('default_responsible_mail_content', 'mod_ildreqdocs')
));
...
$settings->add(new admin_setting_configtext(            
	...
	get_string('default_overview_mail_subject', 'mod_ildreqdocs')
));
...
$settings->add(new admin_setting_configtextarea(            
	...
	get_string('default_overview_mail_content', 'mod_ildreqdocs')
));